...
<section class="my-5 py-5">
    ...
    <div class="mx-auto container text-center" style="display: flex; flex-direction:column; align-items: center; margin-bottom: 120px">
        ...
        <?php } else if (isset($_SESSION['total']) && $_SESSION['total'] != 0) { ?>
            ...
            <p style="font-weight:bold; font-size: 20px">Tổng thanh toán: $ <?php echo $_SESSION['total']; ?></p>
            <!-- <input class="btn btn-primary" type="submit" value="Pay Now" /> -->
...
<script src="https://www.paypal.com/sdk/js?client-id=AXzPDb757lS8RNLH68uipdo6iQNBVGHymNkNEx5DSRNBhP8RVg2vCGZz5eQ9ZGLJWrsqWCVIygbXt-F0&currency=USD">
</script>
<script>
    paypal.Buttons({
