    ...
    <div class="mx-auto container">
        <form id="checkout-form" method="POST" action="server/place_order.php">
            ...
            <div class="form-group checkout-small-element">
                ...
                <input type="text" class="form-control" id="checkout-name" name="name" placeholder="Họ và tên" value="<?php echo $checkout_name; ?>" required />
            </div>
            <div class="form-group checkout-small-element">
                <label>Email</label>
                <input type="email" class="form-control" id="checkout-email" name="email" placeholder="Email" value="<?php echo $checkout_email; ?>" required />
                <!--Hidden-->
